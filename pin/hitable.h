       ...
       // else
        ...
        // Tex Handle and Material
        {
            ...
            */
            ...
            // rest of mat - set with dummy material for now? see Shader::SetMaterial for correct logic
            ...
            if (mat) {
                ...
                const vec4 rwem(mat->m_fRoughness, mat->m_fWrapLighting, mat->m_fEdge, mat->m_fThickness);               
